    ...
    const dict = {
        fr: {
            landing: {
                ...
                howStep1Title: "1. Exportez vos données",
                howStep1Desc: "Depuis Garmin Connect, Strava, Polar Flow ou l'app de votre montre, exportez vos fichiers d'activité (FIT, GPX, TCX).",
                howStep1Tip: "Astuce : Cherchez 'Exporter' dans les détails de l'activité",
                howStep2Title: "2. Importez dans Pulse Analyzer",
                howStep2Desc: "Créez une session et glissez-déposez vos fichiers. L'alignement temporel est automatique !",
                howStep3Title: "3. Désignez votre référence",
                howStep3Desc: "Cliquez sur l'étoile pour définir l'appareil de référence (ex: ceinture thoracique Polar H10).",
                howStep4Title: "4. Analysez les résultats",
                howStep4Desc: "Comparez les scores de fiabilité, visualisez les écarts et obtenez un rapport IA détaillé.",
            ...
            pricing: {
                ...
                features: {
                    ...
                    scoreCalc: "Score de Fiabilité",
                    dropoutDetection: "Détection des Coupures",
        ...
        en: {
            landing: {
                ...
                howStep1Title: "1. Export your data",
                howStep1Desc: "From Garmin Connect, Strava, Polar Flow or your watch app, export your activity files (FIT, GPX, TCX).",
                howStep1Tip: "Tip: Look for 'Export' in activity details",
                howStep2Title: "2. Import into Pulse Analyzer",
                howStep2Desc: "Create a session and drag-drop your files. Time alignment is automatic!",
                howStep3Title: "3. Set your reference",
                howStep3Desc: "Click the star to define the reference device (e.g. Polar H10 chest strap).",
                howStep4Title: "4. Analyze results",
                howStep4Desc: "Compare reliability scores, visualize deviations and get a detailed AI report.",
            ...
            pricing: {
                ...
                features: {
                    ...
                    scoreCalc: "Reliability Score",
                    dropoutDetection: "Dropout Detection",
