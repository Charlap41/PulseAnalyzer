    ...
    const dict = {
        fr: {
            landing: {
                ...
                privacyTitle: "Données Sécurisées",
                privacyDesc: "Mode gratuit : traitement local. Comptes payants : stockage cloud chiffré (Firebase/Google).",
                privacyTag: "CHIFFRÉ",
        ...
        en: {
            landing: {
                ...
                privacyDesc: "Free mode: local processing only. Paid accounts: encrypted cloud storage (Firebase/Google).",
